...
-- ⚠️ WARNING: This will DELETE all existing data in the tables below.
...
-- Drop trigger if it exists to allow transparent re-creation
...
-- DELIVERIES (For dashboard stats/calendar)
